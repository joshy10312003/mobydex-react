                ...
                <div className="card-panel">
                    <div className="card shadow">
                        ...
                        <div className="card-body">
                            <div className="mb-2">
                                <p className="text-secondary d-inline-block align-middle card-text">Popularity: {movie.popularity.toFixed(1)}</p>
                            </div>
            ...
            <div className="col-8 d-inline-block">  
                ...
                <div className="row">
                    ...
                    <Swiper
                        ...
                        onSlideChange={() => console.log('slide change from popular movie slides')}
